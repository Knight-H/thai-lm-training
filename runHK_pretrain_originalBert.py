...
#    python -m torch.distributed.launch --nproc_per_node=8 runHK_pretrain_originalBert.py

training_args = TrainingArguments(
    output_dir="./OriginalBert3",
...
#     do_predict=True, # Whether to run predictions on the test set.
    ...
    per_device_train_batch_size=13, # Batch size per GPU/TPU core/CPU for training.
...
trainer.save_model("./OriginalBert_Final3")
